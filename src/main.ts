...
async function bootstrap() {
  ...
  const whitelist = parseEnvList('CORS_ORIGINS'); // ví dụ: http://localhost:3000,https://app.vinashoes.vn
  const allowCreds = String(process.env.CORS_CREDENTIALS || 'false') === 'true';
